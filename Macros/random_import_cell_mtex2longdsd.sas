%macro random_import_cell_mtex2longdsd(
...
delimiter='09'x firstobs=2 obs=100 truncover lrecl=100000000;
retain ai 0;
...
proc print data=subset_cell_exp(obs=10);run;
