...
title "UBK female gwas first 3 observations for evaluation";
...
%get_top_signal_within_dist(dsdin=b
                           ...
                           ,pos_dist_thrshd=10000000
                           ,dsdout=tops4female); 
title "Top snps from female-GWAS along: gwas1 for female and gwas2 for male";                           
...
%get_top_signal_within_dist(dsdin=c
                           ...
                           ,pos_dist_thrshd=10000000
                           ,dsdout=tops4male);
title "Top snps from male-GWAS along: gwas1 for female and gwas2 for male";                            
...
design_width=1900,
design_height=700,
Labels4gwas_grps=Female_vs_Male Female Male
);
