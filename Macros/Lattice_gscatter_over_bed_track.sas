...
/*	%let yoffset4max_drawmarkersontop=0.01;*/
	...
	/*Note: this macro variable will adjust value based on the ratio of 800/&track_height*/
	%let Yoffset4textlabels=%sysevalf(0.55*800/&track_height);;/*This will enable the snp label locate in the middle at the top cell*/
