...
;
data final;
merge final x1(where=(&yval_var>=0) keep=pos &yval_var &grp_var);
...
begingraph / designwidth=&track_width designheight=&track_height;
   layout lattice / rowdatarange=data columndatarange=data rowgutter=10 columngutter=10;
		 ...
		 %do i=1 %to &max_ord;
          ...
          %end;                            ;
         %end;	
         scatterplot x=pos y=&yval_var/group=&grp_var name="sc" markerattrs=(symbol=circlefilled size=&dotsize);
      endlayout; 
