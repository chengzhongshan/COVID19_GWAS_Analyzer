...
longformdsd,
cell_type_var=cluster,/*It will be used for lattice boxplot headernames*/
sample_grp_var=sample,/*This will be used to generate sample level cell expression statistics*/ 
pheno_var=severity, /*Pheno var will be used as categories for boxplot*/
