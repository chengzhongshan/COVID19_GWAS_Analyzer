%macro deseq_normal_not_optimized(/*for backup purpose*/
...
*Note: need to drop _exp in the final &dsdin to save space;
proc sql;
create table &dsdin(drop=_exp) as
select n,i,
